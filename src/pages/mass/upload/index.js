        ...
        <div className={styles.page}>
            ...
            <main className={styles.content}>
                ...
                <Typography className={styles.subtitle} variant="body1">
                    На данный момент возможна загрузка заявок в статус
                    проработки через этот{" "}
                    <Link
                        underline="hover"
                        target="_blank"
                        href={"/template.xlsx"}
                ...
                <Typography className={styles.subtitle} variant="body2">
                    Если что-то не работает, или чего-то не хватает для решения
                    ваших задач – можно писать в{" "}
                    <Link
                        underline="hover"
